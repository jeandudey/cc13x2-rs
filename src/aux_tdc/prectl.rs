...
impl SRC_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, SRC_A> {
        use crate::Variant::*;
        match self.bits {
            63 => Val(SRC_A::NO_EVENT),
            61 => Val(SRC_A::AUX_SMPH_AUTOTAKE_DONE),
            60 => Val(SRC_A::AUX_ADC_FIFO_NOT_EMPTY),
            59 => Val(SRC_A::AUX_ADC_FIFO_ALMOST_FULL),
            58 => Val(SRC_A::AUX_ADC_IRQ),
            57 => Val(SRC_A::AUX_ADC_DONE),
            56 => Val(SRC_A::AUX_ISRC_RESET_N),
            55 => Val(SRC_A::AUX_TDC_DONE),
            54 => Val(SRC_A::AUX_TIMER0_EV),
            53 => Val(SRC_A::AUX_TIMER1_EV),
            52 => Val(SRC_A::AUX_TIMER2_PULSE),
            51 => Val(SRC_A::AUX_TIMER2_EV3),
            50 => Val(SRC_A::AUX_TIMER2_EV2),
            49 => Val(SRC_A::AUX_TIMER2_EV1),
            48 => Val(SRC_A::AUX_TIMER2_EV0),
            47 => Val(SRC_A::AUX_COMPB),
            46 => Val(SRC_A::AUX_COMPA),
            45 => Val(SRC_A::MCU_OBSMUX1),
            44 => Val(SRC_A::MCU_OBSMUX0),
            43 => Val(SRC_A::MCU_EV),
            42 => Val(SRC_A::ACLK_REF),
            41 => Val(SRC_A::VDDR_RECHARGE),
            40 => Val(SRC_A::MCU_ACTIVE),
            39 => Val(SRC_A::PWR_DWN),
            38 => Val(SRC_A::SCLK_LF),
            37 => Val(SRC_A::AON_BATMON_TEMP_UPD),
            36 => Val(SRC_A::AON_BATMON_BAT_UPD),
            35 => Val(SRC_A::AON_RTC_4KHZ),
            34 => Val(SRC_A::AON_RTC_CH2_DLY),
            33 => Val(SRC_A::AON_RTC_CH2),
            32 => Val(SRC_A::MANUAL_EV),
            31 => Val(SRC_A::AUXIO31),
            30 => Val(SRC_A::AUXIO30),
            29 => Val(SRC_A::AUXIO29),
            28 => Val(SRC_A::AUXIO28),
            27 => Val(SRC_A::AUXIO27),
            26 => Val(SRC_A::AUXIO26),
            25 => Val(SRC_A::AUXIO25),
            24 => Val(SRC_A::AUXIO24),
            23 => Val(SRC_A::AUXIO23),
            22 => Val(SRC_A::AUXIO22),
            21 => Val(SRC_A::AUXIO21),
            20 => Val(SRC_A::AUXIO20),
            19 => Val(SRC_A::AUXIO19),
            18 => Val(SRC_A::AUXIO18),
            17 => Val(SRC_A::AUXIO17),
            16 => Val(SRC_A::AUXIO16),
            15 => Val(SRC_A::AUXIO15),
            14 => Val(SRC_A::AUXIO14),
            13 => Val(SRC_A::AUXIO13),
            12 => Val(SRC_A::AUXIO12),
            11 => Val(SRC_A::AUXIO11),
            10 => Val(SRC_A::AUXIO10),
            9 => Val(SRC_A::AUXIO9),
            8 => Val(SRC_A::AUXIO8),
            7 => Val(SRC_A::AUXIO7),
            6 => Val(SRC_A::AUXIO6),
