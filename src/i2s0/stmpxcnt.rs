...
#[doc = "Writer for register STMPXCNT"]
pub type W = crate::W<u32, super::STMPXCNT>;
#[doc = "Register STMPXCNT `reset()`'s with value 0"]
impl crate::ResetValue for super::STMPXCNT {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `CURR_VALUE`"]
