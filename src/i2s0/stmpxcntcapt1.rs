...
#[doc = "Writer for register STMPXCNTCAPT1"]
pub type W = crate::W<u32, super::STMPXCNTCAPT1>;
#[doc = "Register STMPXCNTCAPT1 `reset()`'s with value 0"]
impl crate::ResetValue for super::STMPXCNTCAPT1 {
    type Type = u32;
    #[inline(always)]
