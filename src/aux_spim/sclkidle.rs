...
#[doc = "Writer for register SCLKIDLE"]
pub type W = crate::W<u32, super::SCLKIDLE>;
#[doc = "Register SCLKIDLE `reset()`'s with value 0x01"]
impl crate::ResetValue for super::SCLKIDLE {
    type Type = u32;
    #[inline(always)]
