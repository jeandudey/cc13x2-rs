...
#[doc = "Writer for register DATAIDLE"]
pub type W = crate::W<u32, super::DATAIDLE>;
#[doc = "Register DATAIDLE `reset()`'s with value 0x01"]
impl crate::ResetValue for super::DATAIDLE {
    type Type = u32;
    #[inline(always)]
