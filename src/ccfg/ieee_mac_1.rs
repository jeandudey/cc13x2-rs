...
#[doc = "Writer for register IEEE_MAC_1"]
pub type W = crate::W<u32, super::IEEE_MAC_1>;
#[doc = "Register IEEE_MAC_1 `reset()`'s with value 0xffff_ffff"]
impl crate::ResetValue for super::IEEE_MAC_1 {
    type Type = u32;
    #[inline(always)]
