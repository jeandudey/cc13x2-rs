#[doc = "Reader of register UDMACH14SSEL"]
pub type R = crate::R<u32, super::UDMACH14SSEL>;
#[doc = "Writer for register UDMACH14SSEL"]
pub type W = crate::W<u32, super::UDMACH14SSEL>;
#[doc = "Register UDMACH14SSEL `reset()`'s with value 0x01"]
impl crate::ResetValue for super::UDMACH14SSEL {
    type Type = u32;
    #[inline(always)]
