...
#[doc = "Writer for register CPUIRQSEL35"]
pub type W = crate::W<u32, super::CPUIRQSEL35>;
#[doc = "Register CPUIRQSEL35 `reset()`'s with value 0x38"]
impl crate::ResetValue for super::CPUIRQSEL35 {
    type Type = u32;
    #[inline(always)]
