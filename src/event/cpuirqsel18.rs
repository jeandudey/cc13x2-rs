...
#[doc = "Writer for register CPUIRQSEL18"]
pub type W = crate::W<u32, super::CPUIRQSEL18>;
#[doc = "Register CPUIRQSEL18 `reset()`'s with value 0x13"]
impl crate::ResetValue for super::CPUIRQSEL18 {
    type Type = u32;
    #[inline(always)]
