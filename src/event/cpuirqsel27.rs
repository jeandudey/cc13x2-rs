...
#[doc = "Writer for register CPUIRQSEL27"]
pub type W = crate::W<u32, super::CPUIRQSEL27>;
#[doc = "Register CPUIRQSEL27 `reset()`'s with value 0x64"]
impl crate::ResetValue for super::CPUIRQSEL27 {
    type Type = u32;
    #[inline(always)]
