...
#[doc = "Writer for register UDMACH5BSEL"]
pub type W = crate::W<u32, super::UDMACH5BSEL>;
#[doc = "Register UDMACH5BSEL `reset()`'s with value 0x34"]
impl crate::ResetValue for super::UDMACH5BSEL {
    type Type = u32;
    #[inline(always)]
