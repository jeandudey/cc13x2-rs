...
#[doc = "Writer for register UDMACH24BSEL"]
pub type W = crate::W<u32, super::UDMACH24BSEL>;
#[doc = "Register UDMACH24BSEL `reset()`'s with value 0x67"]
impl crate::ResetValue for super::UDMACH24BSEL {
    type Type = u32;
    #[inline(always)]
