...
#[doc = "Writer for register UDMACH22BSEL"]
pub type W = crate::W<u32, super::UDMACH22BSEL>;
#[doc = "Register UDMACH22BSEL `reset()`'s with value 0x65"]
impl crate::ResetValue for super::UDMACH22BSEL {
    type Type = u32;
    #[inline(always)]
