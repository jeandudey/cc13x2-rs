...
#[doc = "Writer for register CPUIRQSEL17"]
pub type W = crate::W<u32, super::CPUIRQSEL17>;
#[doc = "Register CPUIRQSEL17 `reset()`'s with value 0x12"]
impl crate::ResetValue for super::CPUIRQSEL17 {
    type Type = u32;
    #[inline(always)]
