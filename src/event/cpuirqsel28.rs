...
#[doc = "Writer for register CPUIRQSEL28"]
pub type W = crate::W<u32, super::CPUIRQSEL28>;
#[doc = "Register CPUIRQSEL28 `reset()`'s with value 0x0b"]
impl crate::ResetValue for super::CPUIRQSEL28 {
    type Type = u32;
    #[inline(always)]
