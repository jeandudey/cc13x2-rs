...
#[doc = "Writer for register CPUIRQSEL37"]
pub type W = crate::W<u32, super::CPUIRQSEL37>;
#[doc = "Register CPUIRQSEL37 `reset()`'s with value 0x05"]
impl crate::ResetValue for super::CPUIRQSEL37 {
    type Type = u32;
    #[inline(always)]
