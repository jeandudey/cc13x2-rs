...
#[doc = "Writer for register UDMACH21BSEL"]
pub type W = crate::W<u32, super::UDMACH21BSEL>;
#[doc = "Register UDMACH21BSEL `reset()`'s with value 0x64"]
impl crate::ResetValue for super::UDMACH21BSEL {
    type Type = u32;
    #[inline(always)]
