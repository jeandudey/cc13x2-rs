...
#[doc = "Writer for register CPUIRQSEL10"]
pub type W = crate::W<u32, super::CPUIRQSEL10>;
#[doc = "Register CPUIRQSEL10 `reset()`'s with value 0x1a"]
impl crate::ResetValue for super::CPUIRQSEL10 {
    type Type = u32;
    #[inline(always)]
