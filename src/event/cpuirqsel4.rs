...
#[doc = "Writer for register CPUIRQSEL4"]
pub type W = crate::W<u32, super::CPUIRQSEL4>;
#[doc = "Register CPUIRQSEL4 `reset()`'s with value 0x07"]
impl crate::ResetValue for super::CPUIRQSEL4 {
    type Type = u32;
    #[inline(always)]
