...
#[doc = "Writer for register CPUIRQSEL8"]
pub type W = crate::W<u32, super::CPUIRQSEL8>;
#[doc = "Register CPUIRQSEL8 `reset()`'s with value 0x23"]
impl crate::ResetValue for super::CPUIRQSEL8 {
    type Type = u32;
    #[inline(always)]
