...
#[doc = "Writer for register CPUIRQSEL36"]
pub type W = crate::W<u32, super::CPUIRQSEL36>;
#[doc = "Register CPUIRQSEL36 `reset()`'s with value 0x25"]
impl crate::ResetValue for super::CPUIRQSEL36 {
    type Type = u32;
    #[inline(always)]
