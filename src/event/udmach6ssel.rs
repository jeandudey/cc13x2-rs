...
#[doc = "Writer for register UDMACH6SSEL"]
pub type W = crate::W<u32, super::UDMACH6SSEL>;
#[doc = "Register UDMACH6SSEL `reset()`'s with value 0x37"]
impl crate::ResetValue for super::UDMACH6SSEL {
    type Type = u32;
    #[inline(always)]
