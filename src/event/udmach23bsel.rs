...
#[doc = "Writer for register UDMACH23BSEL"]
pub type W = crate::W<u32, super::UDMACH23BSEL>;
#[doc = "Register UDMACH23BSEL `reset()`'s with value 0x66"]
impl crate::ResetValue for super::UDMACH23BSEL {
    type Type = u32;
    #[inline(always)]
