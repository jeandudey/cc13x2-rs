...
#[doc = "Writer for register UDMACH8SSEL"]
pub type W = crate::W<u32, super::UDMACH8SSEL>;
#[doc = "Register UDMACH8SSEL `reset()`'s with value 0x74"]
impl crate::ResetValue for super::UDMACH8SSEL {
    type Type = u32;
    #[inline(always)]
