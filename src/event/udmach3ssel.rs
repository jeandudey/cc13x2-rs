...
#[doc = "Writer for register UDMACH3SSEL"]
pub type W = crate::W<u32, super::UDMACH3SSEL>;
#[doc = "Register UDMACH3SSEL `reset()`'s with value 0x29"]
impl crate::ResetValue for super::UDMACH3SSEL {
    type Type = u32;
    #[inline(always)]
