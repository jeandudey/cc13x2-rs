...
#[doc = "Writer for register CPUIRQSEL14"]
pub type W = crate::W<u32, super::CPUIRQSEL14>;
#[doc = "Register CPUIRQSEL14 `reset()`'s with value 0x18"]
impl crate::ResetValue for super::CPUIRQSEL14 {
    type Type = u32;
    #[inline(always)]
