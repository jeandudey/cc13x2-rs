...
#[doc = "`write(|w| ..)` method takes [fetchstat::W](fetchstat::W) writer structure"]
impl crate::Writable for FETCHSTAT {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod fetchstat;
...
#[doc = "`write(|w| ..)` method takes [cpustat::W](cpustat::W) writer structure"]
impl crate::Writable for CPUSTAT {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod cpustat;
...
#[doc = "`write(|w| ..)` method takes [wustat::W](wustat::W) writer structure"]
impl crate::Writable for WUSTAT {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod wustat;
...
#[doc = "`write(|w| ..)` method takes [reg1_0::W](reg1_0::W) writer structure"]
impl crate::Writable for REG1_0 {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod reg1_0;
...
#[doc = "`write(|w| ..)` method takes [reg3_2::W](reg3_2::W) writer structure"]
impl crate::Writable for REG3_2 {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod reg3_2;
...
#[doc = "`write(|w| ..)` method takes [reg5_4::W](reg5_4::W) writer structure"]
impl crate::Writable for REG5_4 {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod reg5_4;
...
#[doc = "`write(|w| ..)` method takes [reg7_6::W](reg7_6::W) writer structure"]
impl crate::Writable for REG7_6 {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod reg7_6;
...
#[doc = "`write(|w| ..)` method takes [loopaddr::W](loopaddr::W) writer structure"]
impl crate::Writable for LOOPADDR {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod loopaddr;
...
#[doc = "`write(|w| ..)` method takes [loopcnt::W](loopcnt::W) writer structure"]
impl crate::Writable for LOOPCNT {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod loopcnt;
