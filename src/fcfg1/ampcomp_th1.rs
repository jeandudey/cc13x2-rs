...
#[doc = "Writer for register AMPCOMP_TH1"]
pub type W = crate::W<u32, super::AMPCOMP_TH1>;
#[doc = "Register AMPCOMP_TH1 `reset()`'s with value 0xff7b_828e"]
impl crate::ResetValue for super::AMPCOMP_TH1 {
    type Type = u32;
    #[inline(always)]
