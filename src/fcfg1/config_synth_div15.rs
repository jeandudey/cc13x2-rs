...
#[doc = "Writer for register CONFIG_SYNTH_DIV15"]
pub type W = crate::W<u32, super::CONFIG_SYNTH_DIV15>;
#[doc = "Register CONFIG_SYNTH_DIV15 `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::CONFIG_SYNTH_DIV15 {
    type Type = u32;
    #[inline(always)]
