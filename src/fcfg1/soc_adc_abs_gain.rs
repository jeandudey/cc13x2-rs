...
#[doc = "Writer for register SOC_ADC_ABS_GAIN"]
pub type W = crate::W<u32, super::SOC_ADC_ABS_GAIN>;
#[doc = "Register SOC_ADC_ABS_GAIN `reset()`'s with value 0"]
impl crate::ResetValue for super::SOC_ADC_ABS_GAIN {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `SOC_ADC_ABS_GAIN_TEMP1`"]
