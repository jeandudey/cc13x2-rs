...
#[doc = "Writer for register CONFIG_SYNTH_DIV2_CC13_2G4"]
pub type W = crate::W<u32, super::CONFIG_SYNTH_DIV2_CC13_2G4>;
#[doc = "Register CONFIG_SYNTH_DIV2_CC13_2G4 `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::CONFIG_SYNTH_DIV2_CC13_2G4 {
    type Type = u32;
    #[inline(always)]
