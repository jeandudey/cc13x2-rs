...
#[doc = "Writer for register MAC_BLE_0"]
pub type W = crate::W<u32, super::MAC_BLE_0>;
#[doc = "Register MAC_BLE_0 `reset()`'s with value 0"]
impl crate::ResetValue for super::MAC_BLE_0 {
    type Type = u32;
    #[inline(always)]
