...
#[doc = "Writer for register BATMONBAT"]
pub type W = crate::W<u32, super::BATMONBAT>;
#[doc = "Register BATMONBAT `reset()`'s with value 0"]
impl crate::ResetValue for super::BATMONBAT {
    type Type = u32;
    #[inline(always)]
