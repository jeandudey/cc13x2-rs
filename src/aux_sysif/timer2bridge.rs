...
#[doc = "Writer for register TIMER2BRIDGE"]
pub type W = crate::W<u32, super::TIMER2BRIDGE>;
#[doc = "Register TIMER2BRIDGE `reset()`'s with value 0"]
impl crate::ResetValue for super::TIMER2BRIDGE {
    type Type = u32;
    #[inline(always)]
