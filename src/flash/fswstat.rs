...
#[doc = "Writer for register FSWSTAT"]
pub type W = crate::W<u32, super::FSWSTAT>;
#[doc = "Register FSWSTAT `reset()`'s with value 0x01"]
impl crate::ResetValue for super::FSWSTAT {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `SAFELV`"]
