...
#[doc = "Writer for register FSM_ACC_EP"]
pub type W = crate::W<u32, super::FSM_ACC_EP>;
#[doc = "Register FSM_ACC_EP `reset()`'s with value 0"]
impl crate::ResetValue for super::FSM_ACC_EP {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Write proxy for field `ACC_EP`"]
