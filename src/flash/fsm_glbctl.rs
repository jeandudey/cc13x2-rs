...
#[doc = "Writer for register FSM_GLBCTL"]
pub type W = crate::W<u32, super::FSM_GLBCTL>;
#[doc = "Register FSM_GLBCTL `reset()`'s with value 0x01"]
impl crate::ResetValue for super::FSM_GLBCTL {
    type Type = u32;
    #[inline(always)]
