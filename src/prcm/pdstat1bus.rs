...
#[doc = "Writer for register PDSTAT1BUS"]
pub type W = crate::W<u32, super::PDSTAT1BUS>;
#[doc = "Register PDSTAT1BUS `reset()`'s with value 0x01"]
impl crate::ResetValue for super::PDSTAT1BUS {
    type Type = u32;
    #[inline(always)]
