...
#[doc = "Writer for register PDSTAT1VIMS"]
pub type W = crate::W<u32, super::PDSTAT1VIMS>;
#[doc = "Register PDSTAT1VIMS `reset()`'s with value 0x01"]
impl crate::ResetValue for super::PDSTAT1VIMS {
    type Type = u32;
    #[inline(always)]
