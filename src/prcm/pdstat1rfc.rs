...
#[doc = "Writer for register PDSTAT1RFC"]
pub type W = crate::W<u32, super::PDSTAT1RFC>;
#[doc = "Register PDSTAT1RFC `reset()`'s with value 0"]
impl crate::ResetValue for super::PDSTAT1RFC {
    type Type = u32;
    #[inline(always)]
