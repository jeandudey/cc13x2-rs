...
#[doc = "Writer for register PDSTAT0SERIAL"]
pub type W = crate::W<u32, super::PDSTAT0SERIAL>;
#[doc = "Register PDSTAT0SERIAL `reset()`'s with value 0"]
impl crate::ResetValue for super::PDSTAT0SERIAL {
    type Type = u32;
    #[inline(always)]
