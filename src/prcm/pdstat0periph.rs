...
#[doc = "Writer for register PDSTAT0PERIPH"]
pub type W = crate::W<u32, super::PDSTAT0PERIPH>;
#[doc = "Register PDSTAT0PERIPH `reset()`'s with value 0"]
impl crate::ResetValue for super::PDSTAT0PERIPH {
    type Type = u32;
    #[inline(always)]
