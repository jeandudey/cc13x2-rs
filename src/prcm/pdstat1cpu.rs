...
#[doc = "Writer for register PDSTAT1CPU"]
pub type W = crate::W<u32, super::PDSTAT1CPU>;
#[doc = "Register PDSTAT1CPU `reset()`'s with value 0x01"]
impl crate::ResetValue for super::PDSTAT1CPU {
    type Type = u32;
    #[inline(always)]
