...
#[doc = "Writer for register PDSTAT0RFC"]
pub type W = crate::W<u32, super::PDSTAT0RFC>;
#[doc = "Register PDSTAT0RFC `reset()`'s with value 0"]
impl crate::ResetValue for super::PDSTAT0RFC {
    type Type = u32;
    #[inline(always)]
