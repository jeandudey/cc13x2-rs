...
#[doc = "Writer for register ID_ISAR1"]
pub type W = crate::W<u32, super::ID_ISAR1>;
#[doc = "Register ID_ISAR1 `reset()`'s with value 0x0211_2000"]
impl crate::ResetValue for super::ID_ISAR1 {
    type Type = u32;
    #[inline(always)]
