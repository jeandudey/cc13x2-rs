...
#[doc = "Writer for register ID_MMFR1"]
pub type W = crate::W<u32, super::ID_MMFR1>;
#[doc = "Register ID_MMFR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID_MMFR1 {
    type Type = u32;
    #[inline(always)]
