...
#[doc = "Writer for register ID_MMFR3"]
pub type W = crate::W<u32, super::ID_MMFR3>;
#[doc = "Register ID_MMFR3 `reset()`'s with value 0"]
impl crate::ResetValue for super::ID_MMFR3 {
    type Type = u32;
    #[inline(always)]
