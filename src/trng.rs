...
#[doc = "`write(|w| ..)` method takes [out0::W](out0::W) writer structure"]
impl crate::Writable for OUT0 {}
#[doc = "Random Number Lower Word Readout Value"]
pub mod out0;
...
#[doc = "`write(|w| ..)` method takes [irqflagstat::W](irqflagstat::W) writer structure"]
impl crate::Writable for IRQFLAGSTAT {}
#[doc = "Interrupt Status"]
pub mod irqflagstat;
...
#[doc = "`read()` method returns [irqflagclr::R](irqflagclr::R) reader structure"]
impl crate::Readable for IRQFLAGCLR {}
...
#[doc = "`write(|w| ..)` method takes [hwopt::W](hwopt::W) writer structure"]
impl crate::Writable for HWOPT {}
#[doc = "TRNG Engine Options Information"]
pub mod hwopt;
...
#[doc = "`write(|w| ..)` method takes [hwver0::W](hwver0::W) writer structure"]
impl crate::Writable for HWVER0 {}
#[doc = "HW Version 0 EIP Number And Core Revision"]
pub mod hwver0;
...
#[doc = "`write(|w| ..)` method takes [irqstatmask::W](irqstatmask::W) writer structure"]
impl crate::Writable for IRQSTATMASK {}
#[doc = "Interrupt Status After Masking"]
pub mod irqstatmask;
...
#[doc = "`write(|w| ..)` method takes [hwver1::W](hwver1::W) writer structure"]
impl crate::Writable for HWVER1 {}
#[doc = "HW Version 1 TRNG Revision Number"]
pub mod hwver1;
