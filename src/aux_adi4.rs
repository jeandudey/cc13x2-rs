...
#[doc = "ADC Reference 1 Control reference used by the ADC. Only to be used through TI provided API."]
pub mod adcref1;
#[doc = "Internal. Only to be used through TI provided API.\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lpmbias](lpmbias) module"]
pub type LPMBIAS = crate::Reg<u8, _LPMBIAS>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _LPMBIAS;
#[doc = "`read()` method returns [lpmbias::R](lpmbias::R) reader structure"]
impl crate::Readable for LPMBIAS {}
#[doc = "`write(|w| ..)` method takes [lpmbias::W](lpmbias::W) writer structure"]
impl crate::Writable for LPMBIAS {}
#[doc = "Internal. Only to be used through TI provided API."]
pub mod lpmbias;
