...
#[doc = "RCOSCHF Control"]
pub mod rcoschfctl;
#[doc = "RCOSC_MF Control\n\nThis register you can [`read`](crate::generic::Reg::read), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rcoscmfctl](rcoscmfctl) module"]
pub type RCOSCMFCTL = crate::Reg<u32, _RCOSCMFCTL>;
#[allow(missing_docs)]
#[doc(hidden)]
pub struct _RCOSCMFCTL;
#[doc = "`read()` method returns [rcoscmfctl::R](rcoscmfctl::R) reader structure"]
impl crate::Readable for RCOSCMFCTL {}
#[doc = "`write(|w| ..)` method takes [rcoscmfctl::W](rcoscmfctl::W) writer structure"]
impl crate::Writable for RCOSCMFCTL {}
#[doc = "RCOSC_MF Control"]
pub mod rcoscmfctl;
