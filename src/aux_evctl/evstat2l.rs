...
#[doc = "Writer for register EVSTAT2L"]
pub type W = crate::W<u32, super::EVSTAT2L>;
#[doc = "Register EVSTAT2L `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT2L {
    type Type = u32;
    #[inline(always)]
