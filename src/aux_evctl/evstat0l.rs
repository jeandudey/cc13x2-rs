...
#[doc = "Writer for register EVSTAT0L"]
pub type W = crate::W<u32, super::EVSTAT0L>;
#[doc = "Register EVSTAT0L `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT0L {
    type Type = u32;
    #[inline(always)]
