...
#[doc = "Writer for register EVSTAT1L"]
pub type W = crate::W<u32, super::EVSTAT1L>;
#[doc = "Register EVSTAT1L `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT1L {
    type Type = u32;
    #[inline(always)]
