...
#[doc = "Writer for register EVSTAT0H"]
pub type W = crate::W<u32, super::EVSTAT0H>;
#[doc = "Register EVSTAT0H `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT0H {
    type Type = u32;
    #[inline(always)]
