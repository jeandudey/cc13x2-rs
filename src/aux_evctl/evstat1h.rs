...
#[doc = "Writer for register EVSTAT1H"]
pub type W = crate::W<u32, super::EVSTAT1H>;
#[doc = "Register EVSTAT1H `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT1H {
    type Type = u32;
    #[inline(always)]
