...
#[doc = "Writer for register EVSTAT3H"]
pub type W = crate::W<u32, super::EVSTAT3H>;
#[doc = "Register EVSTAT3H `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT3H {
    type Type = u32;
    #[inline(always)]
