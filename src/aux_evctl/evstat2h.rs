...
#[doc = "Writer for register EVSTAT2H"]
pub type W = crate::W<u32, super::EVSTAT2H>;
#[doc = "Register EVSTAT2H `reset()`'s with value 0"]
impl crate::ResetValue for super::EVSTAT2H {
    type Type = u32;
    #[inline(always)]
